...
void CapSense_1_TunerComm(void)
{
    ...
    *******************************************************************************/
    void CapSense_1_ProcessAllWidgets(volatile CapSense_1_OUTBOX *outbox)
    {
        ...
        /* Calculate widget with centroids */
            ...
            for(; i < (widgetCnt + (CapSense_1_TOTAL_TRACKPAD_GESTURES_COUNT * 4u)); i=i+4u)
            {
                ...
                (uint8)CapSense_1_DecodeAllGestures((uint32)outbox->fingersNum[CapSense_1_DEFAULT_TRACKPAD_INDEX], trackpadPosBuf);
                     ...
                     */
                    if (((outbox->gestureID[CapSense_1_DEFAULT_TRACKPAD_INDEX] & CapSense_1_GESTURE_TYPE_MASK) == CapSense_1_NON_INERTIAL_SCROLL) ||
                        ((outbox->gestureID[CapSense_1_DEFAULT_TRACKPAD_INDEX] & CapSense_1_GESTURE_TYPE_MASK) == CapSense_1_INERTIAL_SCROLL))
                    {
        ...
        #ifdef CapSense_1_PROCESS_ALL_WIDGETS_CALLBACK
            CapSense_1_ProcessAllWidgets_Callback();
        #endif /* CapSense_1_PROCESS_ALL_WIDGETS_CALLBACK */
    }

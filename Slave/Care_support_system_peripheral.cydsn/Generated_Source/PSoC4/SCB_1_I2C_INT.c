...
CY_ISR(SCB_1_I2C_ISR)
{
...
#ifdef SCB_1_I2C_ISR_ENTRY_CALLBACK
    SCB_1_I2C_ISR_EntryCallback();
#endif /* SCB_1_I2C_ISR_ENTRY_CALLBACK */

#if (SCB_1_I2C_CUSTOM_ADDRESS_HANDLER_CONST)
    uint32 response;

    response = SCB_1_I2C_ACK_ADDR;
    ...
    */
    if(SCB_1_CHECK_I2C_FSM_MASTER)
    {
        #if(SCB_1_I2C_MASTER)
        {
            ...
            */
            ...
            {
                SCB_1_mstrStatus |= (uint16) (SCB_1_I2C_MSTAT_ERR_XFER |
                                                         SCB_1_I2C_MSTAT_ERR_BUS_ERROR);

                endTransfer = SCB_1_I2C_CMPLT_ANY_TRANSFER;
            }
            ...
            */
            ...
            #if(SCB_1_I2C_MULTI_MASTER_SLAVE)
            {
                ...
                */
                ...
                {
                    SCB_1_mstrStatus |= (uint16) (SCB_1_I2C_MSTAT_ERR_XFER |
                                                             SCB_1_I2C_MSTAT_ERR_ABORT_XFER);
            ...
            */
            if(0u != endTransfer)
            {
                ...
                SCB_1_mstrStatus |= (uint16) SCB_1_GET_I2C_MSTAT_CMPLT;

                #if(SCB_1_I2C_MULTI_MASTER_SLAVE)
                {
                    if(SCB_1_CHECK_I2C_FSM_ADDR)
                    {
                        ...
                        */
                        if(SCB_1_CHECK_I2C_MASTER_CMD(SCB_1_I2C_MASTER_CMD_M_START_ON_IDLE))
                        {
                            ...
                            endTransfer = SCB_1_I2C_CMPLT_ANY_TRANSFER; /* Pass control to Slave */
                        }
                        ...
                        */
                        else if((!SCB_1_CHECK_INTR_SLAVE_MASKED(SCB_1_INTR_SLAVE_I2C_BUS_ERROR))
                               && SCB_1_CHECK_INTR_MASTER_MASKED(SCB_1_INTR_MASTER_I2C_ARB_LOST))
                        {
                            endTransfer = SCB_1_I2C_CMPLT_ANY_TRANSFER; /* Pass control to Slave */
                        }
                        else
                        ...
                        {
                            SCB_1_CLEAR_TX_FIFO; /* Shifter keeps address, clear it */

                            SCB_1_DISABLE_MASTER_AUTO_DATA_ACK; /* In case of reading disable autoACK */
    ...
    else /* (SCB_1_CHECK_I2C_FSM_SLAVE) */
    {
        #if(SCB_1_I2C_SLAVE)
        {
            /* INTR_SLAVE_I2C_BUS_ERROR or SCB_1_INTR_SLAVE_I2C_ARB_LOST:
            ...
            */
                                                        ...
                                                        SCB_1_INTR_SLAVE_I2C_ARB_LOST))
            {
                if(SCB_1_CHECK_I2C_FSM_RD)
                {
                    ...
                    SCB_1_slStatus &= (uint8) ~SCB_1_I2C_SSTAT_RD_BUSY;
                    SCB_1_slStatus |= (uint8) (SCB_1_I2C_SSTAT_RD_ERR |
                                                          SCB_1_I2C_SSTAT_RD_CMPLT);
                }
                else
                {
                    /* RX direction: master writes into slave */
                    SCB_1_slStatus &= (uint8) ~SCB_1_I2C_SSTAT_WR_BUSY;
                    SCB_1_slStatus |= (uint8) (SCB_1_I2C_SSTAT_WR_ERR |
                                                          SCB_1_I2C_SSTAT_WR_CMPLT);
                }
                    ...
                    if(SCB_1_CHECK_I2C_FSM_RD) /* Reading */
                    {
                        ...
                        */
                        if(SCB_1_CHECK_INTR_RX_MASKED(SCB_1_INTR_RX_FULL))
                        {
                            ...
                            if(diffCount > SCB_1_I2C_FIFO_SIZE)
                            {
                                diffCount = SCB_1_I2C_FIFO_SIZE;
                            }
                            else
                            {
                                if(0u == diffCount)
                            ...
                            {
                                SCB_1_mstrRdBufPtr[SCB_1_mstrRdBufIndex] = (uint8)
                                                                                        SCB_1_RX_FIFO_RD_REG;
                    ...
                    else /* Writing */
                    {
                        ...
                        */
                        if(SCB_1_CHECK_INTR_MASTER_MASKED(SCB_1_INTR_MASTER_I2C_NACK))
                        {
                            ...
                            SCB_1_mstrWrBufIndexTmp -= (SCB_1_GET_TX_FIFO_ENTRIES +
                                                                   SCB_1_GET_TX_FIFO_SR_VALID);

                            /* Update number of transferred bytes */
                            SCB_1_mstrWrBufIndex = SCB_1_mstrWrBufIndexTmp;
                        ...
                        */
                        ...
                        {
                            while(SCB_1_I2C_FIFO_SIZE != SCB_1_GET_TX_FIFO_ENTRIES)
                            {
                                ...
                                */
                                if(SCB_1_mstrWrBufIndexTmp < SCB_1_mstrWrBufSize)
                                {
                                    ...
                                    */
                                    if(SCB_1_mstrWrBufIndexTmp == (SCB_1_mstrWrBufSize - 1u))
                                    {
                                    ...
                                    SCB_1_TX_FIFO_WR_REG = (uint32) SCB_1_mstrWrBufPtr[SCB_1_mstrWrBufIndexTmp];
                                    SCB_1_mstrWrBufIndexTmp++;
                                }
                                else
                                {
        ...
        #if(SCB_1_I2C_SLAVE)
        {
            ...
            */
            if(SCB_1_CHECK_INTR_SLAVE_MASKED(SCB_1_INTR_SLAVE_I2C_NACK))
            {
                ...
                {
                    SCB_1_slStatus |= (uint8) SCB_1_I2C_SSTAT_RD_OVFL;
                }
                else /* No Overflow */
                {
                    /* Roll-back temporary index */
                    SCB_1_slRdBufIndexTmp -= (diffCount - SCB_1_slOverFlowCount);
                }

                /* Update slave of transferred bytes */
                SCB_1_slRdBufIndex = SCB_1_slRdBufIndexTmp;
                ...
                SCB_1_slStatus &= (uint8) ~SCB_1_I2C_SSTAT_RD_BUSY;
                SCB_1_slStatus |= (uint8)  SCB_1_I2C_SSTAT_RD_CMPLT;
                SCB_1_state     =  SCB_1_I2C_FSM_IDLE;
                
            #ifdef SCB_1_I2C_SLAVE_CMPLT_CALLBACK
                /* Read complete */
                SCB_1_I2C_SlaveCompleteCallback();
            #endif /* SCB_1_I2C_SLAVE_CMPLT_CALLBACK */
            }
            ...
            */
            if(SCB_1_CHECK_INTR_SLAVE_MASKED(SCB_1_INTR_SLAVE_I2C_WRITE_STOP))
            {
                ...
                * I2C_ADDR_MATCH.
                */
                if (0u != (SCB_1_I2C_CTRL_REG & SCB_1_I2C_CTRL_S_READY_DATA_ACK))
                {
                    while(0u != SCB_1_GET_RX_FIFO_ENTRIES)
                    {
                        #if(SCB_1_CHECK_I2C_ACCEPT_ADDRESS)
                        {
                ...
                {
                    SCB_1_slStatus |= (uint8) SCB_1_I2C_SSTAT_WR_OVFL;
                }
                ...
                SCB_1_slStatus &= (uint8) ~SCB_1_I2C_SSTAT_WR_BUSY;
                SCB_1_slStatus |= (uint8)  SCB_1_I2C_SSTAT_WR_CMPLT;
                SCB_1_state     =  SCB_1_I2C_FSM_IDLE;
            ...
            */
        ...
        #endif /* (SCB_1_I2C_CUSTOM_ADDRESS_HANDLER_CONST) */
            {
                ...
                #if (SCB_1_I2C_CUSTOM_ADDRESS_HANDLER)
                {
                    if (NULL != SCB_1_customAddressHandler)
                    {
                        /* Call custom address handler */
                        response = SCB_1_customAddressHandler();
                    }
                    else
                    {
            ...
            #endif /* (SCB_1_I2C_CUSTOM_ADDRESS_HANDLER_CONST) */
                {
                    ...
                    /* TX direction: master reads from slave */
                    {
                        ...
                        SCB_1_slRdBufIndexTmp = SCB_1_slRdBufIndex;
                    ...
                    SCB_1_ENABLE_INTR_SLAVE(SCB_1_INTR_SLAVE_I2C_WRITE_STOP);
                #endif /* (!SCB_1_CY_SCBIP_V0) */
            ...
            */
            if(SCB_1_CHECK_INTR_RX_MASKED(SCB_1_INTR_RX_FULL))
            {
                ...
                diffCount =  SCB_1_slWrBufSize -
                            (SCB_1_slWrBufIndex + SCB_1_I2C_FIFO_SIZE);

                if(diffCount > SCB_1_I2C_FIFO_SIZE) /* Proceed transaction */
                {
                    diffCount   = SCB_1_I2C_FIFO_SIZE;
                    endTransfer = 0u;  /* Continue active transfer */
                }
            ...
            */
            ...
            {
                diffCount = SCB_1_RX_FIFO_RD_REG;
            ...
            */
            if(SCB_1_CHECK_INTR_TX_MASKED(SCB_1_INTR_TX_EMPTY))
            {
                while(SCB_1_I2C_FIFO_SIZE != SCB_1_GET_TX_FIFO_ENTRIES)
                {
                    ...
                    */
                    if(SCB_1_slRdBufIndexTmp < SCB_1_slRdBufSize)
                    /* Data from buffer */
                    {
                        SCB_1_TX_FIFO_WR_REG = (uint32) SCB_1_slRdBufPtr[SCB_1_slRdBufIndexTmp];
                        SCB_1_slRdBufIndexTmp++;
                    }
                    else
                    /* Probably Overflow */
                    {
                        ...
                        if(SCB_1_slOverFlowCount <= SCB_1_I2C_TX_OVERFLOW_COUNT)
                        {
...
#ifdef SCB_1_I2C_ISR_EXIT_CALLBACK
    SCB_1_I2C_ISR_ExitCallback();
#endif /* SCB_1_I2C_ISR_EXIT_CALLBACK */

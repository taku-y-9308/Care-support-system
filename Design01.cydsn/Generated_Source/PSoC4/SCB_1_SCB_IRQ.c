...
{
    #ifdef SCB_1_SCB_IRQ_INTERRUPT_INTERRUPT_CALLBACK
        SCB_1_SCB_IRQ_Interrupt_InterruptCallback();
    #endif /* SCB_1_SCB_IRQ_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling SCB_1_SCB_IRQ_Start or SCB_1_SCB_IRQ_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after SCB_1_SCB_IRQ_Start or SCB_1_SCB_IRQ_StartEx has been called. 
...
void SCB_1_SCB_IRQ_SetPriority(uint8 priority)
{
    ...
    uint32 priorityOffset = ((SCB_1_SCB_IRQ__INTC_NUMBER % 4u) * 8u) + 6u;

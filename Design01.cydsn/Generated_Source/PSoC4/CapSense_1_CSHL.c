...
const uint16 CapSense_1_fingerThreshold[] = {
    100u, 
};

const uint16 CapSense_1_noiseThreshold[] = {
    20u, 
};

const uint16 CapSense_1_hysteresis[] = {
    10u, 
};

const uint8 CapSense_1_debounce[] = {
    5u, 
};
...
void CapSense_1_DisableWidget(uint32 widget)
{
    ...
    *******************************************************************************/
    uint16 CapSense_1_GetCentroidPos(uint32 widget)
    {
        ...
        #if (CapSense_1_IS_DIPLEX_SLIDER)
            maximum = CapSense_1_FindMaximum(offset, count, (uint16)CapSense_1_fingerThreshold[widget], diplex);
        #else
            maximum = CapSense_1_FindMaximum(offset, count, (uint16)CapSense_1_fingerThreshold[widget]);
        #endif /* (CapSense_1_IS_DIPLEX_SLIDER) */
    ...
    *******************************************************************************/
     uint16 CapSense_1_GetRadialCentroidPos(uint32 widget)
    {
        ...
        /* Find Maximum within centroid */
        #if (CapSense_1_IS_DIPLEX_SLIDER)
            maximum = CapSense_1_FindMaximum(offset, count, (uint16)CapSense_1_fingerThreshold[widget], 0u);
        #else
            maximum = CapSense_1_FindMaximum(offset, count, (uint16)CapSense_1_fingerThreshold[widget]);
        #endif /* (CapSense_1_IS_DIPLEX_SLIDER) */

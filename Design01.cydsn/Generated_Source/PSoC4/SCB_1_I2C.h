...
#define SCB_1_I2C_MODE                   (2u)
#define SCB_1_I2C_OVS_FACTOR_LOW         (8u)
#define SCB_1_I2C_OVS_FACTOR_HIGH        (8u)
#define SCB_1_I2C_MEDIAN_FILTER_ENABLE   (1u)
#define SCB_1_I2C_SLAVE_ADDRESS          (0x8u)
#define SCB_1_I2C_SLAVE_ADDRESS_MASK     (0xFEu)
#define SCB_1_I2C_ACCEPT_ADDRESS         (0u)
#define SCB_1_I2C_ACCEPT_GENERAL_CALL    (0u)
#define SCB_1_I2C_WAKE_ENABLE            (0u)
#define SCB_1_I2C_DATA_RATE              (100u)
#define SCB_1_I2C_DATA_RATE_ACTUAL       (100u)
#define SCB_1_I2C_CLOCK_FROM_TERM        (0u)
#define SCB_1_I2C_EXTERN_INTR_HANDLER    (0u)
#define SCB_1_I2C_BYTE_MODE_ENABLE       (0u)
#define SCB_1_I2C_MANUAL_OVS_CONTROL     (1u)
...
#define SCB_1_I2C_MODE_MULTI_MASTER_MASK  (0x04u)
    ...
    #define SCB_1_I2C_SLAVE  (0u != (SCB_1_I2C_MODE_SLAVE & SCB_1_mode))

    /* Returns true if master mode is enabled */
    #define SCB_1_I2C_MASTER (0u != (SCB_1_I2C_MODE_MASTER & SCB_1_mode))

    /* Returns true if multi-master mode is enabled */
    #define SCB_1_I2C_MULTI_MASTER \
                            (0u != (SCB_1_I2C_MODE_MULTI_MASTER_MASK & SCB_1_mode))

    /* Returns true if mode is multi-master-slave */
    #define SCB_1_I2C_MULTI_MASTER_SLAVE \
                            (SCB_1_I2C_MODE_MULTI_MASTER_SLAVE == SCB_1_mode)

    /* Returns true if address accepts in RX FIFO */
    #define SCB_1_CHECK_I2C_ACCEPT_ADDRESS   (0u != SCB_1_acceptAddr)
    #define SCB_1_CHECK_I2C_GENERAL_CALL \
                (0u != (SCB_1_I2C_CTRL_REG & SCB_1_I2C_CTRL_S_GENERAL_IGNORE))

    #define SCB_1_I2C_WAKE_ENABLE_CONST              (1u)
    #define SCB_1_I2C_SLAVE_CONST                    (1u)
    #define SCB_1_I2C_MASTER_CONST                   (1u)
    #define SCB_1_I2C_MULTI_MASTER_SLAVE_CONST       (1u)
    #define SCB_1_CHECK_I2C_ACCEPT_ADDRESS_CONST     (1u)
    #define SCB_1_CHECK_I2C_GENERAL_CALL_CONST       (1u)
    #define SCB_1_I2C_CUSTOM_ADDRESS_HANDLER_CONST   (1u)

    /* Returns FIFO size */
    #if (SCB_1_CY_SCBIP_V0 || SCB_1_CY_SCBIP_V1)
        #define SCB_1_I2C_FIFO_SIZE      (SCB_1_FIFO_SIZE)
    #else
        #define SCB_1_I2C_FIFO_SIZE      (SCB_1_GET_FIFO_SIZE(SCB_1_CTRL_REG & \
    ...
    /* Returns true if multi-master mode is enabled */
    #define SCB_1_I2C_MULTI_MASTER \
                                    (0u != (SCB_1_I2C_MODE_MULTI_MASTER_MASK & SCB_1_I2C_MODE))

    /* Returns true if mode is multi-master-slave */
    #define SCB_1_I2C_MULTI_MASTER_SLAVE \
                                    (SCB_1_I2C_MODE_MULTI_MASTER_SLAVE == SCB_1_I2C_MODE)

    /* Returns true if address accepts in RX FIFO */
    #define SCB_1_CHECK_I2C_ACCEPT_ADDRESS   (0u != SCB_1_I2C_ACCEPT_ADDRESS)
    #define SCB_1_CHECK_I2C_GENERAL_CALL     (0u != SCB_1_I2C_ACCEPT_GENERAL_CALL)

    /* Returns true if wakeup on address match is enabled */
    #define SCB_1_I2C_WAKE_ENABLE_CONST  (0u != SCB_1_I2C_WAKE_ENABLE)

    #define SCB_1_I2C_SLAVE_CONST    (SCB_1_I2C_SLAVE)
    #define SCB_1_I2C_MASTER_CONST   (SCB_1_I2C_MASTER)
    #define SCB_1_I2C_MULTI_MASTER_SLAVE_CONST   (SCB_1_I2C_MULTI_MASTER_SLAVE)
    #define SCB_1_CHECK_I2C_ACCEPT_ADDRESS_CONST (SCB_1_CHECK_I2C_ACCEPT_ADDRESS)
    #define SCB_1_CHECK_I2C_GENERAL_CALL_CONST   (SCB_1_CHECK_I2C_GENERAL_CALL)
    #define SCB_1_I2C_CUSTOM_ADDRESS_HANDLER_CONST   (SCB_1_CHECK_I2C_ACCEPT_ADDRESS_CONST || \
                                                                  SCB_1_CHECK_I2C_GENERAL_CALL_CONST)

    /* I2C: TX or RX FIFO size */
    #define SCB_1_I2C_FIFO_SIZE  SCB_1_GET_FIFO_SIZE(SCB_1_I2C_BYTE_MODE_ENABLE)

    /* Adjust AF and DF filter settings. Ticket ID#176179 */
    #if ((SCB_1_I2C_MODE_SLAVE == SCB_1_I2C_MODE) ||     \
            ((SCB_1_I2C_MODE_SLAVE != SCB_1_I2C_MODE) && \
             (SCB_1_I2C_DATA_RATE_ACTUAL <= SCB_1_I2C_DATA_RATE_FS_MODE_MAX)))

        #define SCB_1_I2C_MEDIAN_FILTER_ENABLE_ADJ       (0u)
        #define SCB_1_I2C_CFG_ANALOG_FITER_ENABLE_ADJ    do{;}while(0)
    #else
        #define SCB_1_I2C_MEDIAN_FILTER_ENABLE_ADJ       (1u)
        #define SCB_1_I2C_CFG_ANALOG_FITER_ENABLE_ADJ    SCB_1_I2C_CFG_ANALOG_FITER_DISABLE
    #endif

    /* Select oversampling factor low and high */
    #define SCB_1_I2C_OVS_FACTOR_LOW_MIN     ((0u != SCB_1_I2C_MANUAL_OVS_CONTROL) ? \
                                                            (8u) : (8u))

    #define SCB_1_I2C_OVS_FACTOR_HIGH_MIN    ((0u != SCB_1_I2C_MANUAL_OVS_CONTROL) ? \
                                                            (8u) : (8u))

#endif /* (SCB_1_SCB_MODE_UNCONFIG_CONST_CFG) */

#define SCB_1_I2C_CUSTOM_ADDRESS_HANDLER (SCB_1_CHECK_I2C_GENERAL_CALL || \
                                                     SCB_1_CHECK_I2C_ACCEPT_ADDRESS)
...
*/
    ...
    void SCB_1_SetI2cAddressCustomInterruptHandler(uint32 (*func) (void));
...
/* I2C Master functions prototypes */
    ...
    uint32 SCB_1_I2CMasterSendStart(uint32 slaveAddress, uint32 bitRnW, uint32 timeoutMs);
    uint32 SCB_1_I2CMasterSendRestart(uint32 slaveAddress, uint32 bitRnW, uint32 timeoutMs);
    uint32 SCB_1_I2CMasterSendStop(uint32 timeoutMs);
    uint32 SCB_1_I2CMasterWriteByte(uint32 wrByte, uint32 timeoutMs);
    uint32 SCB_1_I2CMasterReadByte(uint32 ackNack, uint8* rdByte, uint32 timeoutMs);
...
/* I2C Slave functions prototypes */
    ...
    void   SCB_1_I2CSlaveSetAddressMask(uint32 addressMask);
...
#define SCB_1_I2C_ACK_ADDR           (0u)    /* Send ACK to address */
#define SCB_1_I2C_NAK_ADDR           (1u)    /* Send NAK to address */
#define SCB_1_I2C_ACK_DATA           (0u)    /* Send ACK to data */
#define SCB_1_I2C_NAK_DATA           (1u)    /* Send NAK to data */
...
/* Master status */
#define SCB_1_I2C_MSTAT_CLEAR            ((uint16) 0x00u)   /* Clear (init) status value */

#define SCB_1_I2C_MSTAT_RD_CMPLT         ((uint16) 0x01u)   /* Read complete               */
#define SCB_1_I2C_MSTAT_WR_CMPLT         ((uint16) 0x02u)   /* Write complete              */
#define SCB_1_I2C_MSTAT_XFER_INP         ((uint16) 0x04u)   /* Master transfer in progress */
#define SCB_1_I2C_MSTAT_XFER_HALT        ((uint16) 0x08u)   /* Transfer is halted          */

#define SCB_1_I2C_MSTAT_ERR_MASK         ((uint16) 0x3F0u) /* Mask for all errors                          */
#define SCB_1_I2C_MSTAT_ERR_SHORT_XFER   ((uint16) 0x10u)  /* Master NAKed before end of packet            */
#define SCB_1_I2C_MSTAT_ERR_ADDR_NAK     ((uint16) 0x20u)  /* Slave did not ACK                            */
#define SCB_1_I2C_MSTAT_ERR_ARB_LOST     ((uint16) 0x40u)  /* Master lost arbitration during communication */
#define SCB_1_I2C_MSTAT_ERR_ABORT_XFER   ((uint16) 0x80u)  /* The Slave was addressed before the Start gen */
#define SCB_1_I2C_MSTAT_ERR_BUS_ERROR    ((uint16) 0x100u) /* The misplaced Start or Stop was occurred     */
#define SCB_1_I2C_MSTAT_ERR_XFER         ((uint16) 0x200u) /* Error during transfer                        */

/* Master API returns */
#define SCB_1_I2C_MSTR_NO_ERROR          (0x00u)  /* Function complete without error                       */
#define SCB_1_I2C_MSTR_ERR_ARB_LOST      (0x01u)  /* Master lost arbitration: INTR_MASTER_I2C_ARB_LOST     */
#define SCB_1_I2C_MSTR_ERR_LB_NAK        (0x02u)  /* Last Byte Naked: INTR_MASTER_I2C_NACK                 */
#define SCB_1_I2C_MSTR_NOT_READY         (0x04u)  /* Master on the bus or Slave operation is in progress   */
#define SCB_1_I2C_MSTR_BUS_BUSY          (0x08u)  /* Bus is busy, process not started                      */
#define SCB_1_I2C_MSTR_ERR_ABORT_START   (0x10u)  /* Slave was addressed before master begin Start gen     */
#define SCB_1_I2C_MSTR_ERR_BUS_ERR       (0x100u) /* Bus error has: INTR_MASTER_I2C_BUS_ERROR              */
#define SCB_1_I2C_MSTR_ERR_TIMEOUT       (SCB_1_I2C_MASTER_TIMEOUT) /* Operation timeout        */
...
#define SCB_1_I2C_SSTAT_RD_OVFL          (0x04u)    /* Read overflow: master reads above buffer size */
...
#define SCB_1_I2C_SSTAT_WR_OVFL          (0x40u)    /* Write overflow: master writes above buffer size */
...
#define SCB_1_I2C_SSTAT_RD_CLEAR         (0x0Du)    /* Read Status clear: do not clear */
#define SCB_1_I2C_SSTAT_WR_CLEAR         (0xD0u)    /* Write Status Clear */
...
#define SCB_1_I2C_RESET_ERROR            (0x01u)     /* Flag to re-enable SCB IP */

#define SCB_1_I2C_TX_OVERFLOW_COUNT      (SCB_1_I2C_FIFO_SIZE + 2u)
...
#define SCB_1_I2C_CMPLT_ANY_TRANSFER     (0x01u)
...
/* Returns TRUE if sourceMask is set in SCB_1_I2C_MASTER_CMD_REG: used to check if Start was generated */
#define SCB_1_CHECK_I2C_MASTER_CMD(sourceMask)   (0u != (SCB_1_I2C_MASTER_CMD_REG & (sourceMask)))

/* Returns TRUE if SCB_1_MODE_NO_STOP is set in SCB_1_mstrControl: detects NoStop condition */
#define SCB_1_CHECK_I2C_MODE_NO_STOP(mode)   (0u != (SCB_1_I2C_MODE_NO_STOP & (mode)))

/* Returns TRUE if SCB_1_MODE_REPEAT_START is set: used to detect when generate ReStart condition */
#define SCB_1_CHECK_I2C_MODE_RESTART(mode)   (0u != (SCB_1_I2C_MODE_REPEAT_START  & (mode)))

/* Returns TRUE if SCB_1_state is in one of master states */
...
#define SCB_1_I2C_MASTER_TIMEOUT_POS (31u)
#define SCB_1_I2C_MASTER_TIMEOUT     ((uint32) 0x01u << SCB_1_I2C_MASTER_TIMEOUT_POS)

/* Slave address match or general call */
#define SCB_1_SLAVE_INTR_I2C_ADDR    (SCB_1_INTR_SLAVE_I2C_ADDR_MATCH | \
                                                 SCB_1_INTR_SLAVE_I2C_GENERAL)

/* Send byte condition: used by */
#define SCB_1_INTR_MASTER_SEND_BYTE   (SCB_1_INTR_MASTER_I2C_ACK      | \
                                                  SCB_1_INTR_MASTER_I2C_NACK     | \
                                                  SCB_1_INTR_MASTER_I2C_ARB_LOST | \
                                                  SCB_1_INTR_MASTER_I2C_BUS_ERROR)
/* Receive byte error conditions */
#define SCB_1_INTR_MASTER_RECEIVE_BYTE   (SCB_1_INTR_MASTER_I2C_ARB_LOST | \
                                                     SCB_1_INTR_MASTER_I2C_BUS_ERROR)
/* Stop condition */
#define SCB_1_INTR_MASTER_SEND_STOP  (SCB_1_INTR_MASTER_I2C_STOP     | \
                                                 SCB_1_INTR_MASTER_I2C_ARB_LOST | \
                                                 SCB_1_INTR_MASTER_I2C_BUS_ERROR)
...
#define SCB_1_I2C_RX_CTRL    ((SCB_1_ONE_BYTE_WIDTH - 1u) | \
                                          SCB_1_RX_CTRL_MSB_FIRST    | \
                                          SCB_1_RX_CTRL_ENABLED)

#define SCB_1_I2C_TX_CTRL    ((SCB_1_ONE_BYTE_WIDTH - 1u) | \
...
#define SCB_1_I2C_TLOW_TIME  ((1000u / SCB_1_I2C_DATA_RATE) + \
                                            ((0u != (1000u % SCB_1_I2C_DATA_RATE)) ? (1u) : (0u)))
/* tHIGH = tLOW */
#define SCB_1_I2C_THIGH_TIME (SCB_1_I2C_TLOW_TIME)

#define SCB_1_I2C_SCL_LOW    (0u)
#define SCB_1_I2C_SCL_HIGH   (1u)

/* Timeout in us for tLOW and tHIGH generation (equal to 20ms) */
#define SCB_1_I2C_PHASE_GEN_TIMEOUT      (20000u)

#define SCB_1_I2C_IGNORE_GENERAL_CALL    ((uint32) (0u == SCB_1_I2C_ACCEPT_GENERAL_CALL))

/* Convert the timeout in milliseconds to microseconds */
#define SCB_1_I2C_CONVERT_TIMEOUT_TO_US(timeoutMs)   ((timeoutMs) * 1000u)
...
***************************************/
        ...
        #define SCB_1_I2C_WAKE_ENABLE_ADJ    (SCB_1_I2C_MULTI_MASTER_SLAVE ? \
                                                            (0u) : (SCB_1_I2C_WAKE_ENABLE))
    #else
        #define SCB_1_I2C_WAKE_ENABLE_ADJ    (SCB_1_I2C_WAKE_ENABLE)
    #endif /* (!SCB_1_CY_SCBIP_V0) */

    #define SCB_1_I2C_MODE_MASKED    (SCB_1_I2C_MODE & \
                                                (SCB_1_I2C_MODE_SLAVE | SCB_1_I2C_MODE_MASTER))

    #define SCB_1_I2C_DEFAULT_CTRL \
                                (SCB_1_GET_CTRL_BYTE_MODE  (SCB_1_I2C_BYTE_MODE_ENABLE) | \
                                 SCB_1_GET_CTRL_ADDR_ACCEPT(SCB_1_I2C_ACCEPT_ADDRESS)   | \
                                 SCB_1_GET_CTRL_EC_AM_MODE (SCB_1_I2C_WAKE_ENABLE_ADJ))

    #define SCB_1_I2C_DEFAULT_I2C_CTRL \
                    (SCB_1_GET_I2C_CTRL_HIGH_PHASE_OVS(SCB_1_I2C_OVS_FACTOR_HIGH_MIN)   | \
                     SCB_1_GET_I2C_CTRL_LOW_PHASE_OVS (SCB_1_I2C_OVS_FACTOR_LOW_MIN)    | \
                     SCB_1_GET_I2C_CTRL_S_GENERAL_IGNORE(SCB_1_I2C_IGNORE_GENERAL_CALL) | \
                     SCB_1_GET_I2C_CTRL_SL_MSTR_MODE  (SCB_1_I2C_MODE_MASKED))

    #define SCB_1_I2C_DEFAULT_RX_MATCH ((SCB_1_I2C_SLAVE) ? \
                                (SCB_1_GET_I2C_8BIT_ADDRESS(SCB_1_I2C_SLAVE_ADDRESS) | \
                                 SCB_1_GET_RX_MATCH_MASK   (SCB_1_I2C_SLAVE_ADDRESS_MASK)) : (0u))

    #define SCB_1_I2C_DEFAULT_RX_CTRL \
                                (SCB_1_GET_RX_CTRL_MEDIAN(SCB_1_I2C_MEDIAN_FILTER_ENABLE_ADJ) | \
                                 SCB_1_I2C_RX_CTRL)

    #define SCB_1_I2C_DEFAULT_TX_CTRL  (SCB_1_I2C_TX_CTRL)

    #define SCB_1_I2C_DEFAULT_RX_FIFO_CTRL (0u)
    #define SCB_1_I2C_DEFAULT_TX_FIFO_CTRL (0u)

    /* Interrupt sources */
    #define SCB_1_I2C_DEFAULT_INTR_I2C_EC_MASK   (SCB_1_NO_INTR_SOURCES)
    #define SCB_1_I2C_DEFAULT_INTR_SPI_EC_MASK   (SCB_1_NO_INTR_SOURCES)
    #define SCB_1_I2C_DEFAULT_INTR_RX_MASK       (SCB_1_NO_INTR_SOURCES)
    #define SCB_1_I2C_DEFAULT_INTR_TX_MASK       (SCB_1_NO_INTR_SOURCES)

    #define SCB_1_I2C_DEFAULT_INTR_SLAVE_MASK    ((SCB_1_I2C_SLAVE) ? \
                (SCB_1_I2C_INTR_SLAVE_MASK | \
                 SCB_1_GET_INTR_SLAVE_I2C_GENERAL(SCB_1_I2C_ACCEPT_GENERAL_CALL)) : (0u))

    #define SCB_1_I2C_DEFAULT_INTR_MASTER_MASK   (SCB_1_NO_INTR_SOURCES)

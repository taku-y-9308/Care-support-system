...
module CapSense_CSD_P4_v2_60_3 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("429f3446-c26e-4ab8-a322-5652526ee01a/899719c0-e797-4403-a44f-07a66de2cbeb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("429f3446-c26e-4ab8-a322-5652526ee01a/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Shield_net;
	wire [0:0] tmpFB_0__Shield_net;
	wire [0:0] tmpIO_0__Shield_net;
	wire [0:0] tmpINTERRUPT_0__Shield_net;
	electrical [0:0] tmpSIOVREF__Shield_net;

	cy_psoc3_pins_v1_10
		#(.id("429f3446-c26e-4ab8-a322-5652526ee01a/3d66d0f1-2f2e-44d3-9bb1-527d9165a5f3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	assign tmpOE__Shield_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ab71371b-8c91-4a28-af4b-e05ad32bffb2"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),

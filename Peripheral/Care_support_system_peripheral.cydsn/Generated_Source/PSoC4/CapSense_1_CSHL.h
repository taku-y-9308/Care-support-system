...
void CapSense_1_BaseInit(uint32 sensor);
    ...
    uint8 CapSense_1_FindMaximum(uint8 offset, uint8 count, uint16 fingerThreshold, const uint8 *diplex);
#else
    ...
    uint8 CapSense_1_CalcCentroid(uint8 maximum, uint8 offset, \
                                    uint8 count, uint32 resolution, uint16 noiseThreshold);
#else
    uint8 CapSense_1_CalcCentroid(uint8 maximum, uint8 offset, \
...
uint16 CapSense_1_GetFingerThreshold(uint32 widget);
uint16 CapSense_1_GetNoiseThreshold(uint32 widget);
uint16 CapSense_1_GetFingerHysteresis(uint32 widget);
uint16 CapSense_1_GetNegativeNoiseThreshold(uint32 widget);

#if(CapSense_1_TUNING_METHOD != CapSense_1__TUNING_NONE)
    void CapSense_1_SetFingerThreshold(uint32 widget, uint16 value);
    void CapSense_1_SetNoiseThreshold(uint32 widget, uint16 value);
    void CapSense_1_SetFingerHysteresis(uint32 widget, uint16 value);
    void CapSense_1_SetNegativeNoiseThreshold(uint32 widget, uint16 value);
...
uint16 CapSense_1_GetDiffCountData(uint32 sensor);
void CapSense_1_SetDiffCountData(uint32 sensor, uint16 value);
...
#if (CapSense_1_TUNING_METHOD != CapSense_1__TUNING_NONE)
    extern uint16 CapSense_1_fingerThreshold[CapSense_1_WIDGET_PARAM_TBL_SIZE];
    extern uint16 CapSense_1_noiseThreshold[CapSense_1_WIDGET_PARAM_TBL_SIZE];
    extern uint16 CapSense_1_negativeNoiseThreshold[CapSense_1_WIDGET_PARAM_TBL_SIZE];
    extern uint16 CapSense_1_hysteresis[CapSense_1_WIDGET_PARAM_TBL_SIZE];
    extern uint8  CapSense_1_debounce[CapSense_1_WIDGET_PARAM_TBL_SIZE];
#else
    extern const uint16 CapSense_1_fingerThreshold[CapSense_1_WIDGET_PARAM_TBL_SIZE];
    extern const uint16 CapSense_1_noiseThreshold[CapSense_1_WIDGET_PARAM_TBL_SIZE];
    extern const uint16 CapSense_1_hysteresis[CapSense_1_WIDGET_PARAM_TBL_SIZE];
